...
const fileItem = tv({
    slots: {
        container: 'group flex items-start gap-4 rounded-lg border border-zinc-200 py-6 px-4',
        icon: 'rounded-full borde-4 borde-violet-100 bg-violet-200 p-2 text-violet-600 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-500',
        deleteButton: ''
    },
    ...
    variants: {
        state: {
            ...
            error: {
                ...
                icon: "border-error-50 bg-error-10 text-error-600 dark:border-error-500/5 dark:bg-error-500/30 dark:text-error-400",
    ...
    return (
        <div className={container()}>
            ...
            {state == 'error' ? (
                <div className="flex flex-1 flex-col items-start gap-1">
                    <div className="flex flex-col">
                        ...
                        <span className="text-xs text-error-600 dark:text-error-500">{name}</span>
                    </div>
                    <button type="button" className="text-sm font-semibold text-red-700 hover:text-red-900 dark:text-error-400 dark:hover:text-error-300">
                        Tray again
                    </button>
                </div>
            ) : (
                <div className="flex flex-1 flex-col items-start gap-1">
                    <div className="flex flex-col">
                        ...
                        <span className="text-xs text-zinc-500 dark:text-zinc-400">{formatBytes(size)} kb</span>
                    </div>
            ...
            {state === "complete" ? (
                ...
                <CheckCircle2 className="h-5 w-5 fill-violet-700" />
